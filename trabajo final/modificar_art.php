...
$result=mysql_query("select * from articulo Order By id_art",$link);
...
<form id="form1"  name="form1" method="post" action="Actualiza_datos_art.php" enctype="multipart/form-data">
 <table width="862" border="0" align="center">
<td width="316" height="35" align="center">platillo que modificara</td>
      <td width="76">&nbsp;</td>
      <td width="456" height="35" align="center"><label for="fac"></label>
    <?PHP  
        echo'<select name="id_art">';
