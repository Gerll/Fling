...
<form id="form1"  name="form1" method="post" action="eliminacion_art.php" enctype="multipart/form-data">
 <table width="862" border="0" align="center">
<td width="214" height="35" align="center">usuario que  eliminara</td>
  
      <td width="464" height="35" align="center"><label for="fac"></label>
    <?PHP  
        echo'<select name="usuario">';
		
		while ($row=mysql_fetch_array($result))
        {
	     echo'<option value='.$row["usaurio"].'>'.$row["nombre"].'</option>';
        }
          
		 ?>  
  </select></td>
  <td width="51" height="35"><input type="submit" name="button" id="button" value="Enviar" /></td>
  </table>
  </form>
